...
public class ChannelResourceServlet extends HttpServlet {
	...
	private void doGetConfigInfo(PrintWriter out, String chId, String configField, HttpServletResponse response)
			throws IOException {
		...
		if (channelConfig != null) {
			if (configField.equals("channelAddress")) {
				if (channelConfig.getChannelAddress() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getChannelAddress()));
				}
				...
				if (channelConfig.getDescription() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getDescription()));
				}
				...
				if (channelConfig.getSamplingGroup() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getSamplingGroup()));
				}
			}
				...
				if (channelConfig.getLoggingInterval() == null) {
					...
					out.println(JsonHelper
							.ConfigValueToJson(configField, channelConfig.getLoggingInterval().toString()));
				}
				...
				if (channelConfig.getLoggingTimeOffset() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getLoggingTimeOffset()
							.toString()));
				}
			}
				...
				if (channelConfig.getSamplingInterval() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getSamplingInterval()
							.toString()));
				}
			}
				...
				if (channelConfig.getSamplingTimeOffset() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getSamplingTimeOffset()
							.toString()));
				}
			}
				...
				if (channelConfig.getScalingFactor() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getScalingFactor().toString()));
				}
				...
				if (channelConfig.getValueOffset() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getValueOffset().toString()));
				}
			}
				...
				if (channelConfig.getValueOffset() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.getValueType().name()
							.toString()));
				}
			}
				...
				if (channelConfig.getValueTypeLength() == null) {
					...
					out.println(JsonHelper
							.ConfigValueToJson(configField, channelConfig.getValueTypeLength().toString()));
				}
			}
				...
				if (channelConfig.isDisabled() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.isDisabled().toString()));
				}
			}
				...
				if (channelConfig.isListening() == null) {
					...
					out.println(JsonHelper.ConfigValueToJson(configField, channelConfig.isListening().toString()));
				}
			}
			else {
				response.sendError(HttpServletResponse.SC_NOT_FOUND);
	...
	private void doPutConfigInfo(PrintWriter out, String configValue, String chId, String configField,
			HttpServletResponse response) throws IOException, ConfigWriteException {
		ChannelConfig channelConfig;
		channelConfig = rootCfg.getChannel(chId);
	...
	private void doGetSpecificChannel(PrintWriter out, String chId, HttpServletResponse response) throws IOException {
		...
		if (ids.contains(chId)) {
			...
			Record rc = dataAccess.getChannel(chId).read();
